...
app.get("/api/user/header/:userId", (req, res) => {
  ...
  const query = `
    SELECT 
      ...
      u.lastName,
      u.email,
      COALESCE(us.company, u.company) AS company,
      COALESCE(us.phone, u.phone) AS phone,
      COALESCE(us.profile_picture_url, u.profile_picture_url) AS profile_picture_url
    FROM users u
